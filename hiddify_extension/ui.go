...
func (e *ForceHiddifyConnection) GetUI() ui.Form {
...
func (e *ForceHiddifyConnection) setFormData(data map[string]string) error {
...
func (e *ForceHiddifyConnection) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "ForceHiddifyConnection",
		Description: "Awesome Extension forcehiddifyconnection created by ItsFimall",
		Fields: [][]ui.FormField{
			{{
...
func (e *ForceHiddifyConnection) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "ForceHiddifyConnection",
		Description: "Awesome Extension forcehiddifyconnection created by ItsFimall",
...
func (e *ForceHiddifyConnection) addAndUpdateConsole(message ...any) {
